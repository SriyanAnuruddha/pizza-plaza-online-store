    ...
    <main>
        ...
        <div class="container">
            <div class="dashbord d1">
                    <div class="img-box">
                        <img src="./images/icons/user.png" alt="add" class="dashIcons">
                    </div>
                    <a class="dashLink dl1" href="changeDetails.php?userEmail=<?php echo $_SESSION["userName"];?>">Change Account Details</a>
            </div>                                
            <div class="dashbord d2">
                    <div class="img-box">
                        <img src="./images/icons/purchase2.png" alt="add" class="dashIcons">
                    </div>
                    <a class="dashLink dl2" href="./purchaseHistory.php">View Purchase History</a>
            </div>
        </div>
    </main>
</body>

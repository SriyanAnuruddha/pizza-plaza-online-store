    ...
    <main>  
        <div class="container">
            ...
            <form action="./addProducts.php" method="post" enctype="multipart/form-data">
                ...
                <textarea class="inputBox" name="txtDescription"></textarea>
                <label >Product Image</label>
                <input class="inputBox" type="file" name="imageFile">
                <label >small Price</label>
                <input class="inputBox" type="number" name="smallPrice">
                <label >Medium Price</label>
                <input class="inputBox" type="number" name="mediumPrice">
                <label >large Price</label>
                <input class="inputBox" type="number" name="largePrice">
                ...
                if(isset($_POST["btnSubmit"]))
                {
                    ...
                    $sql = "INSERT INTO `tblproducts` (`pizzaID`, `name`, `description`, `imagePath`, `smallPrice`, `mediumPrice`, `largePrice`)VALUES (NULL, '".$productname."', '".$description."', '".$image."', '".$smallPrice."', '".$mediumPrice."', '".$largePrice."');";
